...
import com.android.chat.ui.activities.AddGroupActivity;
import com.android.chat.ui.adapter.GroupListAdapter;
...
public class GroupFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container,
    ...
    adapter = new GroupListAdapter(getContext(), listGroup);
  ...
  public void onActivityResult(int requestCode, int resultCode, Intent data) {
    ...
    if (requestCode == REQUEST_EDIT_GROUP && resultCode == Activity.RESULT_OK) {
      listGroup.clear();
      GroupListAdapter.listFriend = null;
